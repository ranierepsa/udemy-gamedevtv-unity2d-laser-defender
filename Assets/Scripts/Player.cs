...
public class Player : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        transform.position = new Vector2(Mathf.Clamp(transform.position.x + horizontalMoveSpeed, xMin, xMax), Mathf.Clamp(transform.position.y + verticalMoveSpeed, yMin, yMax));
    }
